(() => {
    ...
    function applySelection(context, variant) {
        ...
        if (cardImage) {
            ...
            cardImage.src = cardArt.getImageURL(variant, "micro");
        }
        ...
        document
            ...
            .forEach((button) => {
                const isSelected =
                    button.dataset.setId === variant.setId &&
                    button.dataset.cardNumber === variant.cardNumber;
        ...
        document
            ...
            .forEach((selector) => {
                ...
                const isOriginal =
                    original?.setId === variant.setId &&
                    original?.cardNumber === variant.cardNumber;
    ...
    function previewVariant(variant) {
        ...
        previewImage.src = cardArt.getImageURL(variant, "preview");
        ...
        if (variant.transformBack) {
            backPreviewImage.referrerPolicy = "no-referrer";
            backPreviewImage.src = cardArt.getImageURL(
                variant.transformBack,
                "preview"
            );
            backPreviewImage.style.display = "";
        } else {
    ...
    function enhanceActionMenu() {
        ...
        originalButton.dataset.setId = original.setId;
        originalButton.dataset.cardNumber = original.cardNumber;
        ...
        if (alternates.length === 1) {
            ...
            alternateButton.dataset.setId = alternate.setId;
            alternateButton.dataset.cardNumber = alternate.cardNumber;
